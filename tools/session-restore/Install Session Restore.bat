@echo off
REM Double-click to install THIS TOOL on this machine. Installs exactly three
...
REM   3. two desktop buttons                  - Restore / Select, pointing at the
REM                                             .bat files in this folder
REM
